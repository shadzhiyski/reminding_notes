...
import 'package:reminding_notes/models/calendar_scroller_view_model.dart';
...
class CalendarScrollerWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) =>
      ChangeNotifierProvider<CalendarScrollerViewModel>(
              ...
              children: [
                DropdownButton<int>(
                  ...
                  items: MONTHS
                      ...
                      .values
                      .toList(),
                  onChanged: (val) => model.selectedMonth = val ?? 0,
                ),
                Padding(
